...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t border-zinc-300'>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          <select value={sortType} className='border border-zinc-300 text-sm px-2' onChange={(e)=>setSortType(e.target.value) } >
